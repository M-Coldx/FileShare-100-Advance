...
def fsub_button(client, message):
    if FORCE_SUB_CHANNEL1 and not FORCE_SUB_CHANNEL2 and not FORCE_SUB_GROUP:
        buttons = [
            [
                InlineKeyboardButton(text="ᴄʜ 1", url=client.invitelink),
            ],
        ]
        try:
            buttons.append(
    ...
    if not FORCE_SUB_CHANNEL1 and FORCE_SUB_CHANNEL2 and not FORCE_SUB_GROUP:
        buttons = [
            [
                InlineKeyboardButton(text="ᴄʜ 2", url=client.invitelink2),
            ],
        ]
        try:
            buttons.append(
    ...
    if not FORCE_SUB_CHANNEL1 and not FORCE_SUB_CHANNEL2 and FORCE_SUB_GROUP:
        buttons = [
            [
                InlineKeyboardButton(text="ɢʀᴜᴘ", url=client.invitelink3),
            ],
        ]
        try:
            buttons.append(
